...
if __name__ == "__main__":
    ...
    traits = []
    models_dir = "models"
    herb_labels_dir = "herb_labels"

    if not os.path.exists(models_dir):
        os.makedirs(models_dir)

    if not os.path.exists(herb_labels_dir):
    ...
    for tests in test_list:
        ...
        learned_model = run_experiments(model, train_data, train_label, val_data, val_label, test_data, test_label, batch_size, num_epoch)
